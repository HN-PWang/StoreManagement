 ...
 */
public abstract class VVICSubscriber<K> implements Observer<ResponseBody> {
    ...
    public VVICSubscriber(Class<K> cls) {
        this.cls = cls;
    }
    ...
    public void onNext(ResponseBody responseBody) {
        try {
            ...
            SMLog.e("VVICSubscriber Exception: " + e.getMessage());
        }
    }

...
public class GetSitePutPresenter extends SMBasePresenter<SiteBean> {

    public GetSitePutPresenter(BaseActivity baseActivity, NetResultListener resultListener, NetLoadingListener loadingListener) {
